...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, ffn_hidden, n_head, drop_prob):
        ...
        self.self_attention = MultiHeadAttention(d_model=d_model, dk=d_model, dv=d_model, n_head=n_head)
        self.norm1 = LayerNorm(d_model=d_model)
        self.dropout1 = nn.Dropout(p=drop_prob)

        self.enc_dec_attention = MultiHeadAttention(d_model=d_model, dk=d_model, dv=d_model, n_head=n_head)
